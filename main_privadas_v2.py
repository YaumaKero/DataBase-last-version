...
# elimina loss años antes del 2015
...
# Elimina las transacciones con "Año" previo a 2015
df_combined = df_combined[df_combined["Año"] >= 2015]

#lineas que tengan todos los valores nulos las elimina
df_combined = df_combined.dropna(how='all')

#Las lineas que sean iguales las elimina
df_combined = df_combined.drop_duplicates(subset=["Compañía adquiridora","Compañía adquirida","Precio","Porcentaje adquirido","Año"])
