...
df_combined["revenue 2023"] = df_combined["revenue"].str.split("\n").str[0]
df_combined["revenue 2022"] = df_combined["revenue"].str.split("\n").str[1]
df_combined["revenue 2021"] = df_combined["revenue"].str.split("\n").str[2]
df_combined["revenue 2020"] = df_combined["revenue"].str.split("\n").str[3]
#parte el string por "    " y quedate con el segundo valor
df_combined["revenue 2023"] = df_combined["revenue 2023"].str.split("    ").str[1]
df_combined["revenue 2022"] = df_combined["revenue 2022"].str.split("    ").str[1]
df_combined["revenue 2021"] = df_combined["revenue 2021"].str.split("    ").str[1]
df_combined["revenue 2020"] = df_combined["revenue 2020"].str.split("    ").str[1]
...
#separamos la columna ebitda en 5 columnas cuando encuentres un \n. Dependiendo de si en el texto hay 2019, 2020, 2021,2022 o 2023 lo guardamos en una columna u otra
#meter un if, si en el texto hay 2019, 2020, 2021,2022 o 2023 lo guardamos en una columna u otra

df_combined["ebitda 2023"] = df_combined["ebitda"].str.split("\n").str[0]
df_combined["ebitda 2022"] = df_combined["ebitda"].str.split("\n").str[1]
df_combined["ebitda 2021"] = df_combined["ebitda"].str.split("\n").str[2]
df_combined["ebitda 2020"] = df_combined["ebitda"].str.split("\n").str[3]
df_combined["ebitda 2023"] = df_combined["ebitda 2023"].str.split("    ").str[1]
df_combined["ebitda 2022"] = df_combined["ebitda 2022"].str.split("    ").str[1]
df_combined["ebitda 2021"] = df_combined["ebitda 2021"].str.split("    ").str[1]
df_combined["ebitda 2020"] = df_combined["ebitda 2020"].str.split("    ").str[1]
...
#en la columna sector, Consumer Goods, Technology y Communication Services cambialo por Technology & Communication Services
df_combined["sector"] = df_combined["sector"].str.replace("Technology","Telecom")
df_combined["sector"] = df_combined["sector"].str.replace("Communication Services","Telecom")
df_combined["sector"] = df_combined["sector"].str.replace("Consumer Goods","Telecom")
#en la columna sector cambia Healthcare por Pharma
df_combined["sector"] = df_combined["sector"].str.replace("Healthcare","Pharma")
#en la columna sector cambia Consumer Cyclical por Automotive
df_combined["sector"] = df_combined["sector"].str.replace("Consumer Cyclical","Automotive")
...
#en la columna revenue 2020 2021 2022 2023 y ebitda 2020 2021 2022 2023 cambia los valores nulos por 0
df_combined["revenue 2020"] = df_combined["revenue 2020"].fillna(0)
df_combined["revenue 2021"] = df_combined["revenue 2021"].fillna(0)
df_combined["revenue 2022"] = df_combined["revenue 2022"].fillna(0)
df_combined["revenue 2023"] = df_combined["revenue 2023"].fillna(0)
df_combined["ebitda 2020"] = df_combined["ebitda 2020"].fillna(0)
df_combined["ebitda 2021"] = df_combined["ebitda 2021"].fillna(0)
df_combined["ebitda 2022"] = df_combined["ebitda 2022"].fillna(0)
df_combined["ebitda 2023"] = df_combined["ebitda 2023"].fillna(0)
...
if respuesta == "s":
    print("¿Qué ID quieres usar como referencia para el filtro por EV?")
